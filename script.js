...
const logos = [
    ...
    { src: 'images/autocad-seeklogo.png', alt: 'Apple' },
    { src: 'images/gmail-logo-icon.png', alt: 'AutoCAD' },
    { src: 'images/slack-icon.svg', alt: 'AutoCAD' },
    { src: 'images/trello-seeklogo.png', alt: 'AutoCAD' },
